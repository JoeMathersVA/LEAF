...
function createRowOpenDialog() {  
    $.ajax({
        ...
        if(!isNaN(recordID) && isFinite(recordID) && recordID != 0) {
            ...
            formGrid.form().getForm(33, 1); // parent ID
...
<button class="buttonNorm" id="createRow"><img src="../libs/dynicons/?img=list-add.svg&amp;w=32" alt="Add Activity">Add Operations Plan Entry</button>
<div id="grid"></div>
